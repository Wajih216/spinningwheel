...
class _SignupScreenState extends State<SignupScreen> {
  ...
  signUp()async{
    var res = await db.createUser(Users(fullName: fullName.text,email: email.text,usrName: usrName.text, password: password.text, phoneNumber: phoneNumber.text));
    if(res>0){
      if(!mounted)return;
            ...
            child: Column(
              ...
              children: [
               const Padding(
                ...
                InputField(hint: "Phone Number", icon: Icons.phone, controller: phoneNumber,passwordInvisible: true),
